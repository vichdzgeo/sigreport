...
formulario_patterns = ([
    ...
    path('maquinaria-list/<int:pk>/',  MaquinariaCoberturaListView.as_view(), name='maquinaria-list'),
    path('maquinaria/<int:pk>/', MaquinariaCoberturaCreate.as_view(),name='maquinaria'),
    path('maquinaria-update/<int:pk>/', MaquinariaCoberturaUpdate.as_view(),name='maquinaria-update'),
